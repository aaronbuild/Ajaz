                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        <h1 className="text-5xl md:text-6xl font-bold mb-6 text-gray-900">
                            AI Skin Check <span className="text-teal-600">Scanner</span>
                        </h1>
                        ...
                        <Button
                            size="lg"
                            className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-4 text-lg rounded-full"
                            asChild
                        >
                            <Link href="/demo">Start Skin Check Now</Link>
                        </Button>
                    </div>
                </div>
            </section>
